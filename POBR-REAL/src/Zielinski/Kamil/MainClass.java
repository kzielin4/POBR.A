	...
	public static void main(final String[] args)
	{
		...
		frame.add(new JButton(new AbstractAction("Load")
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (fd.getFile() == null || (!imageName.substring(imageName.length() - 3).equals(new String("png"))
						&& !imageName.substring(imageName.length() - 3).equals(new String("jpg"))))
				{
					System.out.println(imageName.substring(imageName.length() - 3));
					return;
				}
